...
function initDetails() {
    var details = $('#details').dataTable( {
        ...
        columns: [
            ...
            { "title": "传感器", "class": "center" },
            { "title": "事件", "type": "events", "class": "right" },
            { "title": "严重性", "type": "severity", "class": "center" },
            { "title": "第一次出现", "class": "center", "sType": "date-custom" },
            { "title": "最后一次出现", "class": "center", "sType": "date-custom" },
            { "title": "火线图", "type": "sparkline", "class": "center" },
            { "title": "来源ip", "type": "ip-address", "class": "right" },
            { "title": "来源port", "type": "port", "class": "center" },
            { "title": "目标ip", "type": "ip-address", "class": "right" },
            { "title": "目标port", "type": "port", "class": "center" },
