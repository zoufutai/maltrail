...
function initDetails() {
    var details = $('#details').dataTable( {
        ...
        data: _DATASET,
        columns: [
            { "title": "威胁", "type": "threat", "class": "center" },
            { "title": "嗅探器", "class": "center" },
            { "title": "事件", "type": "events", "class": "right" },
            { "title": "严重程度", "type": "severity", "class": "center" },
            { "title": "首次出现", "class": "center" },
            { "title": "最后出现", "class": "center" },
            { "title": "走势图", "type": "sparkline", "class": "center" },
            { "title": "来源ip", "type": "ip-address", "class": "right" },
            { "title": "来源端口", "type": "port", "class": "center" },
            { "title": "目标ip", "type": "ip-address", "class": "right" },
            { "title": "目标端口", "type": "port", "class": "center" },
            { "title": "协议", "class": "center" },
            { "title": "类型", "class": "center" },
            { "title": "追踪", "class": "trail" },
            { "title": "信息" },
            { "title": "参考" },
            { "title": "标签" }
        ],
...
//                        title = data.split(common).join("").replace(/[()]/g, "");
        ...
        oLanguage: {
            sLengthMenu: "每页 _MENU_ 条消息",  // Reference: http://www.sprymedia.co.uk/dataTables/example_language.html
            sZeroRecords: "没有嗅探到符合条件的流量",
            sInfo: "共 <span class='details_total'>_TOTAL_</span> 条威胁 第 _START_ 条 到 _END_ 流量 ",
